...
과거의 통계데이터를 컴퓨터한테 입력해서 앞으로의 통계 데이터를 예측(predict)하는 기술이라고 보는게 제일 무난할 것 같습니다.<br/>
...
군집화는 데이터를 여러 유형끼리 묶기 위해서 사용합니다<br/>

머신러닝으로 무엇을 할지에 대한 내용은 방대하여 우선은 간략하게 설명하고 추가로 나중에 다시 설명하겠습니다<br/>

# 머신러닝의 학습방법
머신러닝은 크게 지도학습, 비지도 학습, 심화학습 3가지 종류가 있습니다.<br/>
학습이란 단어가 와닿지 않으면, 내가 컴퓨터한테 몇개의 값을 전달하면 되냐로 이해하면 됩니다.
### 지도학습
...
프로그래머 입장에서 만일 변수명을 x나 y로 작성한다면 싸다구 맞아도 할말없겠지만<br/>
